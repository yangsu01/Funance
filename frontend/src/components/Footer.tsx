...
const Footer = ({ version }: Props) => {
  return (
    <footer className="container footer d-flex flex-wrap justify-content-between border-top sticky-bottom mb-3 bg-dark">
      ...
      <ul className="nav col-md-4 justify-content-end list-unstyled d-flex mt-3">
        <li className="ms-3">
          <a className="text-body-secondary" href="https://github.com/yangsu01">
            <svg
        ...
        <li className="ms-3">
          <a
            ...
            href="https://www.linkedin.com/in/yangsu01/"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
