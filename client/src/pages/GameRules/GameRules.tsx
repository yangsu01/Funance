  ...
  return (
    <>
      <Title
        ...
        subtitle="Create a portfolio and watch it grow!"
      />
      <Container>
        <p className="fs-5">
        ...
        <p className="fs-5">
          ...
          as options are not available... (more to come?). Track your
          performance over time and Buy/Sell your way to victory! Assert your
          dominance as a finance bro by out-performing other peoples portfolios!
        </p>
        <p className="fs-5">
          To get started,{" "}
          {userAuthenticated ? (
        ...
        <ul className="fs-5">
          ...
          <li>
            Trades are assumed to be instant and will be executed at quoted
            price
          </li>
          <li>
